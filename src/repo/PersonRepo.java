...
public class PersonRepo {
    public static List<Person> getPeoples() {
        return List.of(aPerson().fname("rohit").lanme("chavan").address(new Address("MH", "Osmanabad", 413501)).phoneNumber(List.of(80586, 805432)).age(25).build(),
                ...
                aPerson().fname(null).lanme("chavan").address(new Address("MH", "Osmanabad", 54666)).phoneNumber(List.of(80544, 845432)).age(22).build(),
                ...
                aPerson().fname(null).lanme("chavan").address(new Address("MH", null, 413501)).phoneNumber(null).age(24).build());
    }
